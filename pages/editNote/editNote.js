...
var UpdateNote_url = app.appServlet.servlet + "UpdateNoteServlet";
var UpdateNoteWithoutSrc_url = app.appServlet.servlet + "UpdateNoteWithoutSrcServlet";
...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      ...
      success: function (res) {
        console.log(res.data)
        if (res.data['0'].n_img1!='')
        that.data.files[0] = app.appServlet.servlet + "upload/" + res.data['0'].n_img1
        if (res.data['0'].n_img2 != '')
        that.data.files[1] = app.appServlet.servlet + "upload/" + res.data['0'].n_img2
        if (res.data['0'].n_img3 != '')
        that.data.files[2] = app.appServlet.servlet + "upload/" + res.data['0'].n_img3
        if (res.data['0'].n_img4 != '')
        that.data.files[3] = app.appServlet.servlet + "upload/" + res.data['0'].n_img4
        that.setData({
          n_note: res.data['0'],
          files:that.data.files,
          seetype:res.data['0'].n_power,
          colortype:res.data['0'].n_color,
          name:res.data['0'].n_place,
          texta:res.data['0'].n_content
        })
