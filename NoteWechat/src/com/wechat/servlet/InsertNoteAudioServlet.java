...
/**
 * Servlet implementation class InsertNoteAudioServlet
 */
@WebServlet("/InsertNoteAudioServlet")
public class InsertNoteAudioServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertNoteAudioServlet() {
        super();
	...
	//	response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		if(n_page.equals("index")) {
			...
			no.setN_audio(new String(request.getParameter("n_audio").getBytes("ISO8859-1"), "UTF-8"));
			
			out.print(new NoteDao().insertNoteAudio(no));
			...
			tn.setTn_audio(new String(request.getParameter("n_audio").getBytes("ISO8859-1"), "UTF-8"));
			
			out.print(new TeamnoteDao().insertTeamnoteAudio(tn));
		}
